...
const simpleModifier = function simpleModifier(modifier) {
  return char => {
    return char + modifier;
  };
};
const barredLetter = function barredLetter(char) {
  switch (char) {
    case 'l':
      return "ł";
    case 'L':
      return "Ł";
    default:
      throw new Error("I do not know how to modify the following string: " + char + ". " + "Change your BiBTeX file or submit a feature request.");
  }
};
const graveAccent = function graveAccent(char) {
  switch (char) {
    case 'e':
      return 'è';
    case 'u':
...
function circledA(char) {
  if (char == 'a') {
    return 'å';
  } else throw new Error("I do not know how to modify the following string: " + char + ". " + "Change your BiBTeX file or submit a feature request.");
}
